...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1341: (x0,x1,x2) => x0.postMessage(x1,x2),
      ...
      _1566: x0 => ({withCredentials: x0}),
      _1567: (x0,x1) => new EventSource(x0,x1),
      ...
      _1570: x0 => x0.close(),
      _1571: (x0,x1,x2) => ({method: x0,body: x1,credentials: x2}),
      _1572: (x0,x1,x2) => x0.fetch(x1,x2),
      _1574: (x0,x1,x2,x3) => x0.replaceState(x1,x2,x3),
      _1575: x0 => x0.random(),
      ...
      _3969: x0 => x0.data,
      _3970: x0 => x0.origin,
      _6145: () => globalThis.document,
      _6227: x0 => x0.body,
      _10703: (x0,x1) => { x0.backgroundColor = x1 },
